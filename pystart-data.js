...

        {
            ...
            content: {
                th: {
                    ...
                    desc: `Python เป็นภาษาโปรแกรมระดับสูง (High-Level Programming Language) ที่ถูกสร้างขึ้นโดย Guido van Rossum และเผยแพร่ครั้งแรกในปี ค.ศ. 1991 Python ได้รับการออกแบบให้มีไวยากรณ์ที่อ่านง่ายเหมือนภาษาอังกฤษ ทำให้ผู้เริ่มต้นเรียนรู้ได้รวดเร็ว

จุดเด่นของ Python มีหลายประการ ได้แก่ โค้ดสั้นกระชับ อ่านง่าย ทำงานได้หลายแพลตฟอร์ม มี Library สำเร็จรูปมากมาย และมีชุมชนนักพัฒนาขนาดใหญ่ที่พร้อมช่วยเหลือ

Python ถูกนำไปใช้งานในหลายสาขา เช่น การพัฒนาเว็บไซต์ (Web Development) ด้วย Django และ Flask, การวิเคราะห์ข้อมูล (Data Science) ด้วย Pandas และ NumPy, ปัญญาประดิษฐ์และ Machine Learning ด้วย TensorFlow และ PyTorch, ระบบอัตโนมัติ (Automation) และการเขียนสคริปต์ต่างๆ

โปรแกรม Python แรกที่นักพัฒนาทุกคนเขียนคือการแสดงข้อความ "Hello, World!" ออกทางหน้าจอ ซึ่งใน Python ทำได้ด้วยคำสั่งเพียงบรรทัดเดียว ต่างจากภาษาอื่นเช่น Java หรือ C++ ที่ต้องเขียนโค้ดหลายบรรทัด`,
                    code:
...
# Python ใช้ # สำหรับเขียน comment (คำอธิบาย)
# comment จะไม่ถูกรันเป็นโค้ด
...
n = "Somchai"              # ไม่ดี — ไม่รู้ว่า n คืออะไร`
            ...
            quiz: {
                q: "ชื่อตัวแปรข้อใดถูกต้องใน Python?",
                options: [
                    "2name",
                    "student_name",
                    "student name",
...
print(num_int + 8)         # 50`
            ...
            quiz: {
                q: "ข้อใดคือชนิดข้อมูลแบบ Boolean?",
                options: [
                    '"True"',
                    "1",
                    "True",
...
print(score >= 60 and score < 80)  # True (เกรด C)`
            ...
            quiz: {
                q: "ผลลัพธ์ของ True and False คืออะไร?",
                options: [
                    "True",
                    "False",
                    "None",
...
print(f"สถานะ: {status}")`
            ...
            quiz: {
                q: "หาก score = 65 จะพิมพ์อะไร? (if score>=80: A elif score>=70: B elif score>=60: C else: F)",
                options: [
                    "A",
                    "B",
                    "C",
...
print(f"ผลรวม 1-100 = {total}")  # 5050`
            ...
            quiz: {
                q: "range(2, 10, 3) ให้ตัวเลขอะไรบ้าง?",
                options: [
                    "2, 5, 8",
                    "2, 3, 4, 5, 6, 7, 8, 9",
                    "3, 6, 9",
...
while True:
    ...
    if choice == "0":
        ...
        print("เพิ่มข้อมูล...")`
            ...
            quiz: {
                q: "while loop หยุดทำงานเมื่อใด?",
                options: [
                    "เมื่อครบจำนวนรอบ",
                    "เมื่อเงื่อนไขเป็น False",
                    "เมื่อเงื่อนไขเป็น True",
                    "หลังจากรัน 100 ครั้ง"
                ],
                ans: 1
            }
        },
...
for num in numbers:
    ...
    print(f"ไม่เจอ {target} ในลิสต์")`
            ...
            quiz: {
                q: "คำสั่งใดใช้ข้ามรอบปัจจุบันของลูปและไปรอบถัดไป?",
                options: [
                    "break",
                    "pass",
                    "continue",
...
for row in matrix:
    ...
    print()`
            ...
            quiz: {
                q: "ถ้า outer loop วน 3 รอบ inner loop วน 5 รอบ inner loop ทำงานรวมกี่ครั้ง?",
                options: [
                    "8 ครั้ง",
                    "5 ครั้ง",
                    "15 ครั้ง",
...
print(a - b)   # Difference: {1,2}`
            ...
            quiz: {
                q: "อะไรคือความแตกต่างหลักระหว่าง List และ Tuple?",
                options: [
                    "List เร็วกว่า Tuple",
                    "Tuple แก้ไขไม่ได้หลังสร้าง",
                    "List ไม่มีลำดับ",
                    "ไม่มีความต่าง"
                ],
                ans: 1
...
print(freq)`
            ...
            quiz: {
                q: "dict.get('key') ต่างจาก dict['key'] อย่างไรเมื่อไม่เจอ key?",
                options: [
                    "ไม่ต่างกัน",
                    "get() คืน None แทน Error",
                    "get() ช้ากว่า",
                    "get() ไม่มีใน Python"
                ],
                ans: 1
...
print(f"{'กลาง':^20}")          # จัดกึ่งกลาง`
            ...
            quiz: {
                q: "'hello world'.title() คืนค่าอะไร?",
                options: [
                    "HELLO WORLD",
                    "hello world",
                    "Hello World",
...
print(lengths)  # {'apple': 5, 'cat': 3, 'elephant': 8}`
            ...
            quiz: {
                q: "[x*2 for x in range(5) if x > 2] ได้ผลลัพธ์อะไร?",
                options: [
                    "[0, 2, 4, 6, 8]",
                    "[6, 8]",
                    "[3, 4]",
...
print(get_grade(75))   # B`
            ...
            quiz: {
                q: "ถ้าฟังก์ชันไม่มีคำสั่ง return จะคืนค่าอะไร?",
                options: [
                    "0",
                    "False",
                    "None",
...
full_func("A", 1, 2, 3, default=20, x=4, y=5)`
            ...
            quiz: {
                q: "*args ใน Python รวบรวม arguments เป็นอะไร?",
                options: [
                    "List",
                    "Tuple",
                    "Dictionary",
...
print(total)  # 8`
            ...
            quiz: {
                q: "LEGB Rule ย่อมาจากอะไร?",
                options: [
                    "Loop, Else, Global, Built-in",
                    "Local, Enclosing, Global, Built-in",
                    "List, Enum, Generator, Boolean",
                    "Lambda, Expression, Group, Block"
                ],
                ans: 1
            }
        },
...
try:
    ...
    print(e)`
            ...
            quiz: {
                q: "finally block ทำงานเมื่อใด?",
                options: [
                    "เมื่อเกิด Exception เท่านั้น",
                    "เมื่อไม่เกิด Exception เท่านั้น",
                    "ทำงานเสมอไม่ว่าจะเกิด Exception หรือไม่",
                    "ไม่ทำงาน"
                ],
                ans: 2
            }
...
print(f"นักศึกษาทั้งหมด: {Student.student_count}")`
            ...
            quiz: {
                q: "__init__ ถูกเรียกอัตโนมัติเมื่อใด?",
                options: [
                    "เมื่อเรียก method ใดก็ตาม",
                    "เมื่อสร้าง Object ใหม่",
                    "เมื่อลบ Object",
                    "เมื่อ import class"
                ],
                ans: 1
...
print(isinstance(dog, Cat))     # False`
            ...
            quiz: {
                q: "super().__init__() ใน Child class ทำหน้าที่อะไร?",
                options: [
                    "สร้าง Child class ใหม่",
                    "เรียก __init__ ของ Parent class",
                    "ลบ Parent class",
                    "Copy attribute จาก Child ไป Parent"
                ],
                ans: 1
            }
        },
...
# print(acc.__balance)  # AttributeError!`
            ...
            quiz: {
                q: "__name (double underscore) ใน Python Class หมายถึงอะไร?",
                options: [
                    "Public attribute ทุกคนเข้าถึงได้",
                    "Protected attribute",
                    "Private attribute ป้องกันการเข้าถึงตรงๆ",
                    "Class attribute ไม่ใช่ instance attribute"
                ],
                ans: 2
            }
        }
...
/* Groups lessons into named units for PyStart Curriculum.html and the
...
/* Per-unit diagnostic (pre) and review (post) tests. Pre-tests probe baseline
   ...
   Scored and stored client-side (see PyStart Quiz.html / Dashboard.html)
