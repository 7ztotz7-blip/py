...
const unitTests = {
    ...
    5: {
      ...
      { q: "โค้ด: class Dog:<br>&nbsp;&nbsp;def __init__(self,name): self.name=name<br>d=Dog(\"Rex\"); print(d.name) ผลลัพธ์คือ?", options: ["Rex", "d.name", "Error", "None"], ans: 0 },
      ...
      { q: "โค้ด: class Animal:<br>&nbsp;&nbsp;def __init__(self,name): self.name=name<br>class Cat(Animal): pass<br>c=Cat(\"Miu\"); print(isinstance(c, Animal)) ผลลัพธ์คือ?", options: ["True", "False", "Error", "None"], ans: 0 },
...
const finalExam = [
      ...
      { q: "Polymorphism ใน OOP หมายถึงอะไร?", options: ["การให้ Object ต่างชนิดกันตอบสนองต่อ method ชื่อเดียวกันได้ในรูปแบบของตัวเอง", "การซ่อนรายละเอียดภายในไม่ให้เข้าถึงจากภายนอกโดยตรง", "การสืบทอดคุณสมบัติจาก Parent Class มาไว้ใน Child Class", "การสร้าง Object ขึ้นมาจาก Class"], ans: 0 },
      ...
      { q: "โค้ด: class Animal:<br>&nbsp;&nbsp;def __init__(self,name): self.name=name<br>class Cat(Animal): pass<br>c=Cat(\"Miu\"); print(isinstance(c, Cat)) ผลลัพธ์คือ?", options: ["True", "False", "Error", "None"], ans: 0 },
